...
# =============================================================================
# =============================================================================
# Classes for corrupting a value in a multi attribute (field) of the data set
# =============================================================================
# ====THIS IS A TEST CODE BY AHMAD====

class CorruptRecord:
  """Base class for the definition of corruptor that is applied on a multi
     attributes (fields) in the data set.

     This class and all of its derived classes provide methods that allow the
     definition of how values in a more that one attribute are corrupted (modified)
     and the parameters necessary for the corruption process.

     The following variables need to be set when a CorruptRecord instance is
...
class CorruptSwapValue(CorruptRecord):
  ...
  def __init__(self, **kwargs):
    ...
    self.name = 'Swap Attributes Value'
    ...
    for (keyword, value) in kwargs.items():
        if(keyword.startswith('first')):
            basefunctions.check_is_string('first_attr', value)
            self.first_attr = value
        elif (keyword.startswith('second')):
            basefunctions.check_is_string('second_attr', value)
            self.second_attr = value
        else:
  ...
  # ---------------------------------------------------------------------------
#AHMAD### in_str change to in_dict to deal with whole record rather than single attribute (string)
  def corrupt_value(self, in_dict):
    """Simply return the missing value string.
    """
    print self.first_attr
    print self.second_attr
    #return self.
# =============================================================================
# END OF TESTING AND DEVELOPING
# =============================================================================
